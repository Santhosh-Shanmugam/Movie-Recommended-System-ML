...
def get_recommendations(title, cosine_sim=cosine_sim):
    ...
    sim_scores = sim_scores[1:11]  # exclude itself and itself's similarity score
    ...
    for i in range(0, 10, 5):
        ...
        for col, j in zip(cols, range(i, i + 5)):
            if j < len(recommendations):
                ...
                movie_id = recommendations.iloc[j]['movie_id']  # Ensure movie_id exists in the DataFrame
